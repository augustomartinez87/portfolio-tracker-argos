      ...
      <main className={`flex-1 transition-all duration-300 mt-16 lg:mt-0 overflow-x-hidden ${sidebarExpanded ? 'lg:ml-56' : 'lg:ml-16'}`}>
        <div className="p-3 lg:p-4 space-y-3">
          <PageHeader
            ...
            subtitle="Rendimiento vs costo de fondeo"
            icon={Bitcoin}
          ...
          {!currentPortfolio ? (
            ...
            <div className="bg-background-secondary border border-border-primary rounded-xl p-6">
              <p className="text-text-tertiary text-sm">Modulo en construccion. Aqui se compararan inversiones cripto vs prestamos Nexo.</p>
            </div>
          )}
        </div>
      </main>
