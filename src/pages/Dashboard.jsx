  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-background-primary flex">
        ...
        <main className={`flex-1 transition-all duration-300 mt-16 lg:mt-0 overflow-hidden h-screen flex flex-col pb-16 lg:pb-0 ${sidebarExpanded ? 'lg:ml-56' : 'lg:ml-16'}`}>
              ...
              <>
                ...
                <div className="min-h-0 flex-1 flex flex-col overflow-hidden">
                  ...
                  {activeTab === 'distribution' && (
                    <div className="flex-1 overflow-y-auto w-full py-4 pr-1 scrollbar-hide lg:custom-scrollbar">
                  ...
                  {activeTab === 'resumen' && (
                    <>
                      ...
                      <div className="bg-background-secondary border border-border-primary rounded-xl flex flex-col flex-1 min-h-0 mt-3 overflow-hidden">
                        <div className="p-2 lg:p-3 border-b border-border-primary flex-shrink-0">
                          <div className="flex items-center gap-2 w-full">
                            ...
                            <div className="flex items-center gap-2 flex-1 min-w-0">
                              <div className="relative flex-1 min-w-0 max-w-[160px]">
                                ...
                                <input type="text" placeholder="Buscar" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-8 pr-3 py-1 h-7 bg-background-tertiary border border-border-primary rounded text-xs text-text-primary placeholder-text-tertiary focus:outline-none focus:border-primary w-full" />
                              </div>
                              <ColumnSelector settings={columnSettings} onSettingsChange={setColumnSettings} />
                            </div>
                            <button onClick={() => { setEditingTrade(null); setModalOpen(true); }} className="flex items-center gap-1.5 px-2.5 sm:px-4 py-1.5 h-8 bg-profit text-white rounded-lg hover:bg-profit/90 transition-all text-xs font-medium shadow-lg shadow-profit/20 flex-shrink-0 whitespace-nowrap">
                        ...
                        <div className="flex-1 overflow-auto min-h-0 scrollbar-hide lg:custom-scrollbar">
